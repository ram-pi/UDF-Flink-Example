package io.confluent.flink.table.modules.remoteudf.wrinkler;
...
public class wrinkler extends ScalarFunction {


    public double eval(String s1, String s2) {
        if (s1 == s2)
            return 1;
        ...
        double jaro_dist =  (((double)match) / ((double)len1)
